        ...
        try {
            ...
            data.forEach(element => {
                if (element.image == null) {
                    ...
                    element.imagelink = request.protocol +'://'+ request.get('host')+ ':' + process.env.BASE_PORT + '/images/articles/' + element.image
                }
            });
    ...
    getSingleArticle: async (request, response) => {
        ...
        try {
            ...
            if (data.image == null) {
                ...
                data.imagelink = request.protocol +'://'+ request.get('host')+ ':' + process.env.BASE_PORT + '/images/articles/' + data.image
            }
