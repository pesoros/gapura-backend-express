        ...
        try {
            ...
            data.forEach(element => {
                if (element.image == null) {
                    ...
                    element.imagelink = 'https://'+ request.get('host')+  '/images/assets/' + element.image
                }
                if (element.file == null) {
                    element.filelink = null
                } else {
                    element.filelink = 'https://'+ request.get('host')+  '/images/assets/' + element.file
                }
            });
    ...
    getSingleAssets: async (request, response) => {
        ...
        try {
            ...
            if (data.image == null) {
                ...
                data.imagelink = 'https://'+ request.get('host')+  '/images/assets/' + data.image
            }

            if (data.file == null) {
                data.filelink = null
            } else {
                data.filelink = 'https://'+ request.get('host')+  '/images/assets/' + data.file
            }
