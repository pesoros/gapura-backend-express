        ...
        try {
            ...
            data.forEach(element => {
                if (element.image == null) {
                    ...
                    element.imagelink = request.get('host')+ ':81/images/assets/' + element.image
                }
                if (element.file == null) {
                    element.filelink = null
                } else {
                    element.filelink = request.get('host')+ ':81/images/assets/' + element.file
                }
            });
    ...
    getSingleAssets: async (request, response) => {
        ...
        try {
            ...
            if (data.image == null) {
                ...
                data.imagelink = request.get('host')+ ':81/images/assets/' + data.image
            }

            if (data.file == null) {
                data.filelink = null
            } else {
                data.filelink = request.get('host')+ ':81/images/assets/' + data.file
            }
