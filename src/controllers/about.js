        ...
        try {
            ...
            data.forEach(element => {
                if (element.image == null) {
                    ...
                    element.imagelink = request.protocol +'://'+ request.get('host')+  '/images/about/' + element.image
                }
            });
    ...
    getSingleAbout: async (request, response) => {
        ...
        try {
            ...
            if (data.image == null) {
                ...
                data.imagelink = request.protocol +'://'+ request.get('host')+  '/images/about/' + data.image
            }
